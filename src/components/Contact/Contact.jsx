...
const profileSocialLinks = [
  profile.github && { name: 'GitHub', href: profile.github, icon: GITHUB_ICON },
  profile.linkedin && { name: 'LinkedIn', href: profile.linkedin, icon: LINKEDIN_ICON },
  profile.website && { name: 'Website', href: profile.website, icon: WEBSITE_ICON },
  {
    name: 'Email',
                ...
                <div className="contact__socials-grid">
                  {profileSocialLinks.map(link => (
                    <a
                      ...
                      target={link.href.startsWith('https://') || link.href.startsWith('http://') ? '_blank' : undefined}
                      rel={link.href.startsWith('https://') || link.href.startsWith('http://') ? 'noopener noreferrer' : undefined}
