        ...
        <div className="project-card__back">
          ...
          {project.responsibilities && project.responsibilities.length > 0 && (
            <div className="project-card__section">
              <p className="project-card__section-label">Responsibilities</p>
          ...
          {project.outcomes && project.outcomes.length > 0 && (
            <div className="project-card__section">
              <p className="project-card__section-label">Outcomes</p>
              <ul className="project-card__list">
      ...
      <div className="container">
        <div className="section-header fade-in">
          ...
          <p className="section-subtitle">
            Personal projects I&apos;ve built — hover each card for details
          </p>
        </div>
